        ...
        <div class="container d-block border border-2  rounded-4 w-50 p-2 bg-light">
            ...
            <form action="action.php" method="POST" enctype="multipart/form-data">
                <div class="row f_field">
                    ...
                    <input class="col-sm-9 justify-content-start f_in" type="text" id="e_name" name="fullname" value="<?php echo $row['Name'];?>" required>
                </div>
                <div class="row f_field">
                    <label class="col-sm-3" for="lname">Enter Category</label>
                    <input class="col-sm-9 justify-content-start f_in" type="text" id="e_category" name="category" value="<?php echo $row['Category'];?>" 
                        required>
                </div>
                <div class="row f_field">
                    <label class="col-sm-3" for="mail">Enter Description</label>
                    <input class="col-sm-9 justify-content-start f_in " type="text" id="e_desc" name="desc" value="<?php echo $row['Description'];?>" required>
                </div>
                <div class="row f_field">
                    <label class="col-sm-3" for="pwd">Enter Price</label>
                    <input class="col-sm-9 justify-content-start f_in " type="number" id="e_price" name="price" value="<?php echo $row['Price'];?>"
                        required>
                </div>
                <div class=" f_field">
                ...
                <div class="">
                    <input class=" f_in file " type="file" id="cpwd" name="image" value="<?php echo $row['Images'];?>" required>
                </div>
                 <input type="hidden" name="id" value="<?php echo $pid; 
                        }?>" >
                <div class="d-flex justify-content-center f_field">
                    <button class="sign_up" type="submit" name="editProduct" value="">SUBMIT</button>
                </div>
            </form>
        </div>
    </div>
